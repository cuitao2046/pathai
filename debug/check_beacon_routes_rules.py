...
+ 指定柱子 F1-C-0104/F1-C-0111/F1-C-0128（旧 0192/0206/0238）是否被利用
"""
import json
import math
...
print("\n" + "=" * 62)
print("柱子利用检查：F1-C-0104 / F1-C-0111 / F1-C-0128（旧 0192/0206/0238）")
for cid in ("F1-C-0104", "F1-C-0111", "F1-C-0128"):
